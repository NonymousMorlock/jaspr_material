...
abstract class Icons {
  ...
  static const gMobiledata = '&#xF010';
  ...
  /// <i class="material-icons md-36">goat</i> &#x2014; material icon named "goat".
  ...
  /// <i class="material-icons md-36">keyboard_command</i> &#x2014; material icon named "keyboard command".
  ...
  /// <i class="material-icons md-36">keyboard_option</i> &#x2014; material icon named "keyboard option".
  ...
  /// <i class="material-icons md-36">wifi_tethering_error_rounded</i> &#x2014; material icon named "wifi tethering error rounded".
